...
class NewPictureLabel extends StatefulWidget {
  NewPictureLabel({Key key}) : super(key: key);

  @override
  _NewPictureLabelState createState() => _NewPictureLabelState();
}

class _NewPictureLabelState extends State<NewPictureLabel> {
  @override
